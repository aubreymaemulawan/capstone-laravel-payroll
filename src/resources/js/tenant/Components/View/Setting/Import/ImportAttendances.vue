...
export default {
    ...
    methods: {
        ...
        sampleDownload() {
            ...
            this.downloadCSV(
                `${keys.join(",")}\n` +
                `emp-01,2021-05-06 09:00:00,2021-05-06 16:10:00,attendance-note${commas}\n` +
                `emp-02,2021-09-06 09:30:00,2021-09-06 16:30:00,attendance-note${commas}\n` +
                `emp-03,2021-12-06 10:00:00,2021-12-06 17:00:00,attendance-note${commas}\n`
            );
        },
